defmodule Immunity.CLI do
  @moduledoc """
  Command-line parsing for `Immunity`.
  """
  ...
  def parse_args(argv) do
    ...
    opts = Keyword.update(opts, :parts, @default_parts, &Immunity.CLI.part_list/1)
    cond do
      unhandled != [] ->
        usage()
      Enum.count(argv) == 1 ->
  ...
  def usage() do
    ...
    IO.puts(:stderr, "Usage: immunity [--parts=#{parts}] [--verbose] <input_file>")
    System.halt(64)
  end
end
